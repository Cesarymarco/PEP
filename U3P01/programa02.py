...
def saludar(nombre, pApellido, sApellido, curso  = "2DAW"):
    print(f"Hola {nombre} {pApellido} {sApellido}, bienvenido a {curso}")

saludar("Daniel","Garcia","Mora")
saludar("Daniel","Garcia","Mora","1DAW")
saludar(pApellido="Garcia",nombre="Daniel",sApellido="Mora")